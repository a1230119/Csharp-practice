...
namespace Practice_14._2___DataRelation.SchoolDataSetTableAdapters {
    ...
    public partial class DepartmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Department] WHERE (([DNO] = @Original_DNO) AND ([DNAME] = @Ori" +
                "ginal_DNAME))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Department] SET [DNO] = @DNO, [DNAME] = @DNAME WHERE (([DNO] = @Ori" +
                "ginal_DNO) AND ([DNAME] = @Original_DNAME));\r\nSELECT DNO, DNAME FROM Department " +
                "WHERE (DNO = @DNO)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Practice_14._2___DataRelation.Properties.Settings.Default.SchoolConnectionString;
        }
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([SID] = @Original_SID) AND ((@IsNull_NAME = 1 AND [NAME] IS NULL) OR ([NAME] = @Original_NAME)) AND ([SEX] = @Original_SEX) AND ((@IsNull_PHONE = 1 AND [PHONE] IS NULL) OR ([PHONE] = @Original_PHONE)) AND ([DNO] = @Original_DNO))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [SID] = @SID, [NAME] = @NAME, [SEX] = @SEX, [PHONE] = @PHONE, [DNO] = @DNO WHERE (([SID] = @Original_SID) AND ((@IsNull_NAME = 1 AND [NAME] IS NULL) OR ([NAME] = @Original_NAME)) AND ([SEX] = @Original_SEX) AND ((@IsNull_PHONE = 1 AND [PHONE] IS NULL) OR ([PHONE] = @Original_PHONE)) AND ([DNO] = @Original_DNO));
SELECT SID, NAME, SEX, PHONE, DNO FROM Student WHERE (SID = @SID)";
        ...
        public virtual int Delete(string Original_SID, string Original_NAME, string Original_SEX, string Original_PHONE, string Original_DNO) {
            ...
            if ((Original_DNO == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_DNO));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
